            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MachineId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MachinePurpose = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    MachineMake = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    MachineModel = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
